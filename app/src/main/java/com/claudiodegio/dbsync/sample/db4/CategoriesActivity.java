...
import com.claudiodegio.dbsync.sample.db2.InsertCategoryActivity;
...
public class CategoriesActivity extends BaseActivity implements TableViewerFragment.OnEditListener {
    ...
    public void onItemEdit(long id, String[] data) {
        Intent intent = new Intent(this, com.claudiodegio.dbsync.sample.db2.InsertCategoryActivity.class);
