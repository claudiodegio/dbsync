...
public class SyncStatus {
    ...
    @IntDef({OK, ERROR_WRITING_TMP_DB, ERROR_UPLOAD_CLOUD, ERROR_GENERATE_UUID, ERROR_DOWNLOAD_CLOUD, ERROR_PARSING_COULD_DB, ERROR})
    ...
    static final int ERROR_PARSING_COULD_DB = 105;
